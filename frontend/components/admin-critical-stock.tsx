            ...
            <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-lg font-medium text-orange-900">Stock Critique</CardTitle>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                {loading ? (
                    ...
                    <div className="space-y-3">
                        {products.map((product) => (
                            <div key={product.id} className="flex items-center justify-between rounded-md border border-orange-100 bg-white p-2">
                                ...
                                <Button variant="ghost" size="sm" asChild className="h-8 text-orange-700 hover:text-orange-900 hover:bg-orange-100">
